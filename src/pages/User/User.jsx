                ...
                <div className="userUpdate">
                    ...
                    <form className="userUpdateForm">
                        <div className="userUpdateLeft">
                            ...
                            <div className="userUpdateItem">
                                <label>Phone</label>
                                <input type="text" placeholder="0193788 949844" className="userUpdateInput" />
                            </div>
                            <div className="userUpdateItem">
                                <label>Address</label>
                        ...
                        <div className="userUpdateRight">
                            <div className="userUpdateUpload">
                                <img src="https://images.pexels.com/photos/3992656/pexels-photo-3992656.png?auto=compress&cs=tinysrgb&dpr=2&w=500" className="userUpdateImg" alt="" />
                                <label htmlFor="file"> 
